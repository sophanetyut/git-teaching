...
namespace testGitAspNet.Controllers
{
    public class ProvincesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,CountryId")] Province province)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,CountryId")] Province province)
        {
            if (ModelState.IsValid)
            {
